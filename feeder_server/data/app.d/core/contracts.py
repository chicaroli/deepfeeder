...
class JournalStore(Protocol):
    ...
    def stream_ticks_since(self, since_ts_ns: int, *, provider_filter: Optional[Set[str]] = None, stream_filter: Optional[Set[str]] = None, page_rows: int = 20_000, canonical: bool = True, by_updated: bool = False) -> Iterator[List[Tick]]: ...
